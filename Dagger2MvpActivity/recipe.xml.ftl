...
<recipe>
    ...
    <instantiate from="root/src/app_package/Module.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${moduleName}.java" />
    
  <instantiate from="root/src/app_package/Component.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${componentName}.java" />
    ...
    <open file="${escapeXmlAttribute(srcOut)}/${moduleName}.java" />
  
    <open file="${escapeXmlAttribute(srcOut)}/${componentName}.java" />
